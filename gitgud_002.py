...
fpath = r'C:\Users\Matt\OneDrive - Florida State University\Fall 2022\CEN4020\paper1\archive\1995.pdf'
fpath_1 = r'C:\Users\Matt\OneDrive - Florida State University\Fall 2022\CEN4020\paper1\archive'
...
for z in range(len(page_text)):
    page_text[z] = preprocess_text(page_text[z])

sentences = print(page_text[130])
